...
class TestSummaryGenerationServiceExtended:
    ...
    def test_create_summary_prompt_with_content_truncation(self):
        ...
        with patch.object(service, "_extract_main_content", return_value=long_content):
            prompt = service._create_summary_prompt("dummy content")
...
"""
        ...
        with patch(
            ...
            result = service._extract_main_content(comment_only_content)
...
"""
        ...
        result = service._extract_main_content(mixed_content)

        # Should identify that there is real content
        assert result != ""

    def test_extract_main_content_with_pandoc_failure_fallback(self):
        """Test _extract_main_content falls back to simple extraction when Pandoc fails."""
        # Create a mock settings object
        mock_settings = Mock()
        mock_settings.openai_api_key = "test-key"
...
"""
        ...
        with patch(
            ...
            result = service._extract_main_content(content)
    ...
    def test_extract_main_content_with_pandoc_failure_only_comments(self):
        """Test _extract_main_content fallback returns empty string when only comments exist."""
        # Create a mock settings object
        mock_settings = Mock()
        mock_settings.openai_api_key = "test-key"
...
"""
        ...
        with patch(
            ...
            result = service._extract_main_content(content_only)
    ...
    def test_clean_summary_with_quotes(self):
        ...
        # Test with quotes
        result = service._clean_summary('"This is a quoted summary"')
        assert result == "This is a quoted summary."

        # Test with single quotes
        result = service._clean_summary("'Another quoted summary'")
    ...
    def test_clean_summary_with_prefixes(self):
        ...
        for prefix in prefixes:
            ...
            result = service._clean_summary(test_summary)
    ...
    def test_format_summary_wraps_text(self):
        ...
        long_summary = "This is a very long summary that should be wrapped to multiple lines because it exceeds the 88 character limit that is set for formatting purposes."
    ...
    def test_format_summary_with_short_text(self):
        ...
        assert len(non_empty_lines) == 2  # Header + content
